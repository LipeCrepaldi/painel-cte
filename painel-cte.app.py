...
# Senhas criptografadas manualmente para garantir compatibilidade
passwords = ["senha123", "senha456"]  # Senhas normais, será necessário criptografar

# Gerar o hash das senhas
